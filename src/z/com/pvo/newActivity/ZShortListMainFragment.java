 ...
 */
public class ZShortListMainFragment extends PVOFragment implements TabHost.OnTabChangeListener,
		ViewPager.OnPageChangeListener, AnimationListener, OnClickListener {

	private ViewPager viewpager;
	private TabHost tabHost;
	private HashMap<String, TabInfo> mapTabInfo = new HashMap<String, ZShortListMainFragment.TabInfo>();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup view, Bundle savedInstanceState) {
		...
		MainFragmentActivity.setTitle("Sort List");
	...
	private void initialiseTabHost() {
		...
		// 1)
		ZShortListMainFragment.AddTab(ZShortListMainFragment.this,this.tabHost,this.tabHost.newTabSpec("Property").setIndicator(createTabView(getActivity(),"Property",R.drawable.notification_home_ic)),
		(tabInfo = new TabInfo("Property", ZShortListedPropertyListActivity.class)));
		this.mapTabInfo.put(tabInfo.tag, tabInfo);
		
		ZShortListMainFragment.AddTab(ZShortListMainFragment.this,this.tabHost,this.tabHost.newTabSpec("Requirement").setIndicator(createTabView(getActivity(), "Requirement",R.drawable.notification_doc)),
		(tabInfo = new TabInfo("Requirement", ZShortListedPropertyListActivity.class)));
		this.mapTabInfo.put(tabInfo.tag, tabInfo);
	 ...
	 */
	private static void AddTab(ZShortListMainFragment activity, TabHost tabHost, TabHost.TabSpec tabSpec, TabInfo tabInfo) {
	...
	private class NewTabViewPagerAdapter extends FragmentStatePagerAdapter {
		...
		public Fragment getItem(int pos) {
			...
			switch (pos) {
				case 0:
					return ZShortListedPropertyListActivity.newInstance();
				case 1:
					return ZShortListedPropertyListActivity.newInstance();
	...
	private NewTabViewPagerAdapter recreateParentFragmentListAdapter() {
        List<ZShortListMainFragment> fragments = new ArrayList<ZShortListMainFragment>(3);
