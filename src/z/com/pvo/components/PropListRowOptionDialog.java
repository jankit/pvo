 ...
 */
public class PropListRowOptionDialog
{
    ...
    public static final int GRAVITY_CENTER = Gravity.CENTER_VERTICAL;
    /**
     * 对话框本身
     */
    ...
    public PropListRowOptionDialog(Context context)
    {
        initDialog(context);
    }
     ...
     * 设置提示框中要显示的内容
     */
    public PropListRowOptionDialog setLayout(View layout)
    {
        if (layout != null)
        {
     ...
     * 设置提示框中要显示的内容的布局Id
     */
    public PropListRowOptionDialog setLayoutResourceId(int layoutResourceId)
    {
     ...
     * 设置三角形所在的位置
     */
    public PropListRowOptionDialog setLocation(int[] location)
    {
     ...
     */
    public PropListRowOptionDialog setLocationByAttachedView(View attachedView)
    {
     ...
     */
    public PropListRowOptionDialog setGravity(int gravity)
    {
     ...
     */
    public PropListRowOptionDialog setMatchParent(boolean matchParent)
    {
     ...
     * 距离屏幕左右的边距
     */
    public PropListRowOptionDialog setMarginLeftAndRight(int left, int right)
    {
     ...
     * 设置触摸对话框外面，对话框是否消失
     */
    public PropListRowOptionDialog setTouchOutsideDismiss(boolean touchOutsideDismiss)
    {
     ...
     * 设置提醒框外部区域的颜色
     */
    public PropListRowOptionDialog setOutsideColor(int color)
    {
     ...
     */
    @SuppressLint("NewApi")
	public PropListRowOptionDialog setBackgroundColor(int color)
    {
     ...
     * 显示提示框
     */
    public PropListRowOptionDialog show()
    {
        if (dialog != null)
        {
            if (contentView == null)
     ...
     * */
    public PropListRowOptionDialog setAnimationTranslationShow(int direction, int duration, float... values)
    {
     ...
     * @param values 动画移动的位置
     * */
    public PropListRowOptionDialog setAnimationTranslationDismiss(int direction, int duration, float... values)
    {
        return setAnimationTranslation(false, direction, duration, values);
    }

    @SuppressLint("NewApi")
	private PropListRowOptionDialog setAnimationTranslation(boolean isShow, int direction, int duration, float... values)
    {
     ...
     * @param values 动画移动的位置
     * */
    public PropListRowOptionDialog setAnimationAlphaShow(int duration, float... values)
    {
     ...
     * @param values 动画移动的位置
     * */
    public PropListRowOptionDialog setAnimationAlphaDismiss(int duration, float... values)
    {
        return setAnimationAlpha(false, duration, values);
    }

    @SuppressLint("NewApi")
	private PropListRowOptionDialog setAnimationAlpha(boolean isShow, int duration, float... values)
    {
...
//        ObjectAnimator.ofFloat(rlOutsideBackground.findViewById(R.id.rlParentForAnimate), "scaleY", 0.3f, 1.0f).setDuration(500).start();
     ...
     * 设置是否可以按返回按钮取消
     * */
    public PropListRowOptionDialog setCancelable(boolean cancelable)
    {
