...
public class NiftyDialogBuilder extends Dialog implements DialogInterface {
    ...
    private final String defMsgColor="#FFFFFF";
    ...
    public static NiftyDialogBuilder getInstance(Activity context) {
    ...
    private void init(Context context) {
        ...
        mDialogView = View.inflate(context, R.layout.z_dialog_layout_common, null);
	...
	public void toDefault(){
       // mTitle.setTextColor(Color.parseColor(defTextColor));
        ...
        mLinearLayoutView.setBackgroundColor(Color.WHITE);
    }
