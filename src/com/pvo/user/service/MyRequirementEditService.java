...
public class MyRequirementEditService extends PVOService<JSONObject>{

	@Override
	public JSONObject executeService(String... params) throws Exception {
		HttpClient httpclient = new DefaultHttpClient();
		HttpPost httppost = new HttpPost(Constant.EditMyRequirement.URL);
			...
			System.out.println("Edit My Requirement Query String "+Constant.EditMyRequirement.URL+"&"+queryString);
			System.out.println("Edit My Requirement response Json String "+responseJsonStr );
