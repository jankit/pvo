...
public class GroupListService  extends PVOService<JSONArray>{

	@Override
	public JSONArray executeService(String... params) throws Exception{
		HttpClient httpclient = new DefaultHttpClient();
		HttpPost httppost = new HttpPost(Constant.GroupList.URL);
			
			List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>();
			nameValuePairs.add(new BasicNameValuePair(Constant.GroupList.AGENT_ID, params[0]));
			...
			System.out.println("group list query string:- "+Constant.GroupList.URL+"&"+queryString);
