...
public class ReadNotificationService extends PVOService<JSONObject> {
	...
	public JSONObject executeService(String... params) throws Exception {
		...
		HttpPost httppost = new HttpPost(Constant.ReadNotifaction.URL);
			
		List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>();
		
		nameValuePairs.add(new BasicNameValuePair(Constant.ReadNotifaction.NOTIFICATION_ID, params[0]));
