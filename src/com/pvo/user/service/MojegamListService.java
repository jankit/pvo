...
public class MojegamListService extends PVOService<JSONArray>{

	@Override
	public JSONArray executeService(String... params) throws Exception{
		HttpClient httpclient = new DefaultHttpClient();
		HttpPost httppost = new HttpPost(Constant.MojegamList.URL);
			
		List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>();
		nameValuePairs.add(new BasicNameValuePair(Constant.MojegamList.TALUKA_ID, params[0]));
		...
		System.out.println("Mojegam Query String "+Constant.MojegamList.URL +"&"+queryString);
