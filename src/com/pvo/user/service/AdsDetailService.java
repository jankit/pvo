...
public class AdsDetailService extends PVOService<JSONArray> {
	...
	public JSONArray executeService(String... params) throws Exception{
		...
		System.out.println("ads detail Query String "+Constant.AdsDetail.URL +"&"+queryString);
		//System.out.println("Ads detail response Json String "+responseJsonStr );
