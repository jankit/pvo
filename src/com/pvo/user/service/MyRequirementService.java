...
public class MyRequirementService  extends PVOService<JSONArray>{

	@Override
	public JSONArray executeService(String... params) throws Exception{
		HttpClient httpclient = new DefaultHttpClient();
		HttpPost httppost = new HttpPost(Constant.MyRequirement.URL);
			...
			if(params.length > 2) {
				...
				System.out.println("My requirement Query String "+Constant.MyRequirement.URL +"&"+queryString);
			} else {
				nameValuePairs.add(new BasicNameValuePair(Constant.MyRequirement.USER_ID, params[0]));
				nameValuePairs.add(new BasicNameValuePair(Constant.MyRequirement.PAGE, params[1]));
				httppost.setEntity(new UrlEncodedFormEntity(nameValuePairs));
				String queryString = Utils.getQueryString(nameValuePairs);
				System.out.println("My requirement Query String "+Constant.MyRequirement.URL +"&"+queryString);
			}
