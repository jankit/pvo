...
public class FindByPropertyIdService extends PVOService<JSONArray> {
	...
	public JSONArray executeService(String... params) throws Exception{
		...
		HttpPost httppost = new HttpPost(Constant.FindByPropertyId.URL);
			
			List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>();
			nameValuePairs.add(new BasicNameValuePair(Constant.FindByPropertyId.PROPERTY_ID, params[0]));
			nameValuePairs.add(new BasicNameValuePair(Constant.FindByPropertyId.USER_ID,params[1]));
			...
			System.out.println("Find proerty by id Qurety String ===> "+Constant.FindByPropertyId.URL+"&"+queryString);
