...
public class JantriListService extends PVOService<JSONArray>{

	@Override
	public JSONArray executeService(String... params) throws Exception{
		HttpClient httpclient = new DefaultHttpClient();
		HttpPost httppost = new HttpPost(Constant.Jantri.URL);
			
		List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>();
		nameValuePairs.add(new BasicNameValuePair(Constant.Jantri.MOJEGAM_ID, params[0]));
		...
		System.out.println("Jantri List Query String "+Constant.Jantri.URL +"&"+queryString);
